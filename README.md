...
**G1** (CI, every PR): local test ircd E2E with no-LLM guard. **G2** (after deploy): live smoke. A release is not shippable without both. Full definition: `docs/brief/JEEVES_BRIEF.md` §0.
