...
| K6 | **The `BobJeeves` service is Disabled** and Jeeves runs from the scheduled task `BobJeeves-chair` | section 4.3 | Jeeves as its own Windows service (agentic_build #330), replacing the task. |
